...
```{r echo=TRUE, paged.print=TRUE, cache=FALSE}
...
```{r highVSlowFO, echo=TRUE, file='highVSlowFO.r', paged.print=FALSE}
```
```{r  highVSlowFOplot, echo=TRUE, fig.height=5, fig.width=6, paged.print=FALSE, dpi=600}
...
```{r regWMHcsFO, file='regWMHvsFO.r', paged.print=FALSE}

```

```{r regWMHvsFOplot-prep, file='regWMHvsFOplot.r', paged.print=FALSE}

```
```{r regWMHvsFOplot, fig.height=8, fig.width=12, paged.print=FALSE, dpi=600}
...
```{r regFOvsTMT, file='regFOvsTMT.r', paged.print=FALSE, cache=TRUE}

```

```{r regFOvsTMTplot-prep, file='regFOvsTMTplot.r', paged.print=FALSE, cache=TRUE}
...
```{r regWMHvsFOplot-sens, fig.height=8, fig.width=12, paged.print=FALSE, dpi=600}
...
```{r regFOvsTMTplot-sens, fig.height=8, fig.width=12, paged.print=FALSE, dpi=600}
