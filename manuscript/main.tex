...
\data[]{Preprocessed data is available on \href{https://github.com/csi-hamburg/HCHS-brain-states-RR}{https://github.com/csi-hamburg/HCHS-brain-states-RR}.}
\funding[]{{Hertie Network of Excellence in Clinical Neuroscience (Dr Schlemm)}}
...
\begin{tikzpicture}[remember picture,overlay]
	...
	\node[anchor=north west,yshift=575pt,xshift=-160pt]
	{ \href{https://doi.org/10.24072/pci.rr.100576}{\includegraphics[height=35mm]{badge_PCI_RR.png}} } ;
\end{tikzpicture}
